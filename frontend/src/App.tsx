  ...
  <svg viewBox="0 0 160 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="roen-grad" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <stop offset="50%" stopColor="#7A553A" />
        <stop offset="100%" stopColor="#6D5239" />
      </linearGradient>
    ...
    <g filter="url(#glow)">
      {/* Dune Curves - elegant minimal lines */}
      <path d="M 5 70 Q 40 50, 80 70 T 155 70" stroke="url(#roen-grad)" strokeWidth="3" fill="none" />
      <path d="M 15 80 Q 50 65, 90 80 T 145 80" stroke="url(#roen-grad)" strokeWidth="2" fill="none" opacity="0.6" />
      
      {/* Glowing Star/Sun */}
      <circle cx="80" cy="40" r="8" fill="url(#roen-grad)" />
      <circle cx="80" cy="40" r="16" fill="url(#roen-grad)" opacity="0.2" className="animate-[slow-pulse_4s_ease-in-out_infinite]" />
    </g>
  </svg>
);

const DesertNightSky = () => {
  return (
    <div className="fixed inset-0 overflow-hidden -z-10 desert-bg opacity-100 pointer-events-none">
      <div className="grain-overlay"></div>
      
      {/* Subtle dunes/horizon glow */}
      ...
      <div className="absolute -bottom-[20%] -left-[10%] w-[120%] h-[40%] bg-primary/10 rounded-[100%] blur-[100px]"></div>
    </div>
  );
};
...
const VoiceAssistantOverlay = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-background/95 backdrop-blur-2xl flex flex-col items-center justify-center transition-all duration-500 animate-in fade-in zoom-in-95">
      <button 
        onClick={onClose}
        className="absolute top-8 right-8 p-3 rounded-full bg-foreground/5 hover:bg-foreground/10 border border-white/10 text-muted-foreground hover:text-foreground transition-all"
      >
        <X size={24} />
      </button>
      ...
      <div className="relative w-80 h-80 flex items-center justify-center">
        ...
        {/* Warm ring */}
        <div className="absolute inset-4 rounded-full border-[1px] border-primary/30 shadow-[0_0_40px_rgba(176,137,104,0.1),inset_0_0_30px_rgba(176,137,104,0.1)] animate-[slow-pulse_6s_ease-in-out_infinite]"></div>
        
        {/* Center calm core */}
        <div className="absolute w-24 h-24 rounded-full bg-gradient-to-br from-primary via-accent to-primary/50 shadow-[0_0_80px_rgba(122,85,58,0.3)] flex items-center justify-center opacity-90">
          <Mic size={32} className="text-background" />
        </div>
      </div>

      <div className="mt-16 flex flex-col items-center">
        <h2 className="text-3xl font-display font-bold text-foreground mb-3">Hi, I'm River</h2>
    ...
    <>
      ...
      <nav className="fixed top-0 left-0 right-0 z-40 px-6 py-4 flex items-center justify-between backdrop-blur-xl bg-background/50 border-b border-border/50">
        <div className="flex items-center gap-2">
          ...
          <span className="font-display font-bold text-xl tracking-tight text-foreground hidden md:block">RoenRiviera</span>
        </div>
        ...
        <div className="hidden md:flex items-center gap-1 bg-card/60 backdrop-blur-md border border-border/60 rounded-full px-2 py-1.5 shadow-lg">
          <Link to="/dashboard" className="px-4 py-1.5 rounded-full text-sm font-medium text-muted-foreground hover:bg-foreground/5 hover:text-foreground transition-colors">Dashboard</Link>
          <Link to="/chat" className="px-4 py-1.5 rounded-full text-sm font-medium text-muted-foreground hover:bg-foreground/5 hover:text-foreground transition-colors">Chat</Link>
          <Link to="/knowledge" className="px-4 py-1.5 rounded-full text-sm font-medium text-muted-foreground hover:bg-foreground/5 hover:text-foreground transition-colors">Knowledge Base</Link>
          <Link to="/timetable" className="px-4 py-1.5 rounded-full text-sm font-medium text-muted-foreground hover:bg-foreground/5 hover:text-foreground transition-colors">Timetable</Link>
        </div>
      ...
      <main className="pt-32 pb-24 px-6 max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="flex flex-col items-center text-center mb-24 mt-20 w-full relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-[5rem] font-display font-bold tracking-tight leading-[1.1] max-w-4xl mb-8">
            Your campus, <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent via-primary to-primary">intelligently connected.</span>
          </h1>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <button onClick={() => navigate('/dashboard')} className="px-8 py-4 rounded-full bg-primary text-primary-foreground font-medium hover:bg-secondary transition-all shadow-[0_0_30px_rgba(122,85,58,0.4)] flex items-center gap-2 text-base group">
              Open Dashboard <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
            </button>
            <button className="px-8 py-4 rounded-full border border-border/80 bg-card/40 backdrop-blur-md text-foreground font-medium hover:bg-card/80 transition-all text-base">
              Learn More
            </button>
          </div>
        </div>
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-12 gap-6 mb-24 relative z-10">
          <div className="md:col-span-8 p-8 rounded-3xl bg-card/40 backdrop-blur-xl border border-border/60 shadow-2xl flex flex-col justify-between relative overflow-hidden group">
            ...
            <div className="flex justify-between items-start mb-8 relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-display font-bold text-2xl text-foreground">Syllabus & Notes</h3>
            ...
            <div className="relative z-10 grid grid-cols-2 gap-4">
              <div className="p-5 rounded-2xl bg-background/60 border border-border/50 backdrop-blur-sm">
                ...
                <div className="flex items-end gap-2">
                  <span className="text-5xl font-mono font-bold text-foreground drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]">99.4</span>
              ...
              <div className="p-5 rounded-2xl bg-background/60 border border-border/50 backdrop-blur-sm">
                ...
                <div className="flex items-end gap-2">
                  <span className="text-5xl font-mono font-bold text-foreground">12.4</span>
          ...
          <div className="md:col-span-4 p-8 rounded-3xl bg-card/40 backdrop-blur-xl border border-border/60 shadow-2xl flex flex-col justify-between group relative overflow-hidden">
            ...
            <div className="mb-6 relative z-10">
              ...
              <h3 className="font-display font-bold text-xl text-foreground mb-2">Timetable Sync</h3>
            ...
            <div className="space-y-3 relative z-10">
              <div className="flex items-center justify-between p-3.5 rounded-xl bg-background/60 border border-border/50 backdrop-blur-sm text-sm">
                <div className="flex items-center gap-2.5">
                  <CheckCircle2 size={18} className="text-primary drop-shadow-[0_0_8px_rgba(122,85,58,0.6)]" />
                  <span className="text-foreground font-medium">Schedule Match</span>
                </div>
          ...
          <div className="md:col-span-12 p-10 rounded-3xl bg-gradient-to-br from-card/80 to-background/40 backdrop-blur-xl border border-border/60 shadow-2xl relative overflow-hidden">
             ...
             <h3 className="font-display font-bold text-3xl text-foreground mb-10 text-center tracking-tight">How it works</h3>
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
               <div className="flex flex-col items-center text-center relative group">
                 ...
                 <h4 className="font-bold text-lg text-foreground mb-3">Gather Data</h4>
               ...
               <div className="flex flex-col items-center text-center relative group">
                 <div className="w-20 h-20 rounded-2xl bg-background border border-primary/50 flex items-center justify-center mb-6 shadow-[0_0_20px_rgba(122,85,58,0.2)] z-10 transition-transform group-hover:-translate-y-1">
                   <span className="font-mono text-xl font-bold text-primary">02</span>
                 </div>
                 <h4 className="font-bold text-lg text-foreground mb-3">Analyze & Organize</h4>
               ...
               <div className="flex flex-col items-center text-center group">
                 <div className="w-20 h-20 rounded-2xl bg-primary border border-primary flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(122,85,58,0.4)] z-10 transition-transform group-hover:-translate-y-1">
                   <span className="font-mono text-xl font-bold text-foreground">03</span>
                 </div>
                 <h4 className="font-bold text-lg text-foreground mb-3">Get Answers</h4>
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input 
              type="text" 
              placeholder="Search..." 
              className="pl-10 pr-4 py-2 bg-card/50 border border-border/50 rounded-full text-sm focus:outline-none focus:border-primary/50 text-foreground placeholder:text-muted-foreground w-64 backdrop-blur-sm"
            />
          </div>
        </div>
      </div>
      ...
      <div className="lg:col-span-2 space-y-6">
        <div className="p-6 rounded-2xl bg-background/60 border border-border/50 backdrop-blur-sm group hover:border-primary/30 transition-colors">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-semibold text-foreground">River Assistant</h3>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-5 rounded-2xl bg-background/40 border border-border/50">
             <h4 className="text-foreground font-medium mb-1">Knowledge Base</h4>
          ...
          <div className="p-5 rounded-2xl bg-background/40 border border-border/50">
             <h4 className="text-foreground font-medium mb-1">Recent Queries</h4>
             <p className="text-2xl font-mono text-accent font-bold">128</p>
          </div>
        </div>
      </div>
      <div className="space-y-4">
        <h3 className="font-medium text-foreground mb-4">Active Workflows</h3>
  ...
  return (
    <div className="flex flex-col items-center justify-center h-[calc(100vh-4rem)] relative w-full overflow-hidden px-4">
      ...
      <div className="text-center mb-12 relative z-10 max-w-4xl mx-auto w-full">
        <h2 className="text-4xl font-display font-bold text-foreground mb-4 tracking-tight drop-shadow-lg">
      ...
      <div className="w-full max-w-3xl relative z-10">
        ...
        <div className="absolute -inset-1 bg-gradient-to-r from-primary/30 via-accent/20 to-primary/30 rounded-3xl blur-xl opacity-70"></div>
        
        <div className="relative bg-card/90 backdrop-blur-2xl border border-border/80 rounded-2xl p-2 shadow-2xl flex flex-col transition-all duration-300">
          <input 
            type="text" 
            placeholder="Ask anything..."
            className="w-full bg-transparent px-4 py-5 text-lg text-foreground placeholder:text-muted-foreground focus:outline-none"
          />
          ...
          <div className="flex items-center justify-between px-2 pb-2 pt-2 border-t border-border/30">
            ...
            <div className="flex items-center gap-2">
              <button 
                ...
                className="flex items-center justify-center w-8 h-8 rounded-full bg-background/50 hover:bg-background border border-border text-muted-foreground hover:text-foreground hover:border-primary/50 transition-colors"
              >
                <Mic size={16} />
              </button>
              
              <button className="w-8 h-8 rounded-full bg-primary hover:bg-secondary flex items-center justify-center text-primary-foreground transition-all shadow-[0_0_15px_rgba(122,85,58,0.4)]">
                <ArrowRight size={16} />
              </button>
            </div>
          </div>
      ...
      <div className="flex flex-wrap justify-center gap-3 mt-8 relative z-10">
        {["Check my timetable conflicts", "Summarize OS Unit 3", "When is the exam deadline?"].map((prompt, i) => (
          <button key={i} className="px-4 py-2 rounded-full bg-card/40 border border-border/50 text-sm text-muted-foreground hover:text-foreground hover:border-primary/40 transition-colors backdrop-blur-md">
            {prompt}
          </button>
        ))}
      </div>
    ...
    <div className="flex justify-between items-center mb-8">
      <div className="flex gap-2">
        {['All Documents', 'Syllabi', 'Official Notices', 'Study Material'].map((tab, i) => (
          <button key={i} className={`px-4 py-2 rounded-full text-sm font-medium ${i === 0 ? 'bg-primary text-primary-foreground shadow-[0_0_15px_rgba(122,85,58,0.3)]' : 'bg-background/40 text-muted-foreground hover:text-foreground border border-border/50'}`}>
            {tab}
          </button>
        ))}
      </div>
      <button className="flex items-center gap-2 bg-foreground text-background px-4 py-2 rounded-lg text-sm font-semibold hover:bg-gray-200 transition-colors">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
       {[
         ...
         <div key={i} className="bg-background/40 border border-border/50 rounded-xl p-5 hover:border-primary/40 transition-all cursor-pointer group">
            ...
            <h4 className="text-sm font-semibold text-foreground mb-1 truncate">{doc.name}</h4>
  ...
  <PageLayout title="Timetable & Conflict Detection">
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div className="lg:col-span-2 bg-background/40 border border-border/50 rounded-2xl p-6">
         <h3 className="font-semibold text-foreground mb-6">Upcoming Schedule</h3>
         <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex gap-4 items-start p-4 rounded-xl bg-card/40 border border-border/30">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-foreground">{slot.course}</h4>
      ...
      <div className="bg-background/40 border border-border/50 rounded-2xl p-6">
         <h3 className="font-semibold text-foreground mb-4">Conflict Detector</h3>
         <div className="bg-primary/10 border border-primary/20 rounded-xl p-4 mb-4">
            <div className="flex items-start gap-3">
               <Calendar size={18} className="text-primary shrink-0 mt-0.5" />
               <div>
                  <h4 className="text-sm font-semibold text-foreground mb-1">Mid-Term Clash Detected</h4>
         ...
         <button className="w-full py-2 bg-card border border-border rounded-lg text-sm text-foreground hover:bg-card/80 transition-colors">
...
const AppShell = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className="min-h-screen text-foreground font-sans relative selection:bg-primary/30 selection:text-foreground">
      ...
      {location.pathname !== '/' && (
        <div className="fixed top-0 left-0 right-0 z-40 bg-background/60 backdrop-blur-xl border-b border-border/50 h-16 flex items-center px-6 justify-between">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-display font-bold text-foreground tracking-tight hidden md:block">RoenRiviera</span>
          </Link>
          <div className="flex gap-6">
             ...
             <Link to="/chat" className={`text-sm font-medium transition-colors ${location.pathname === '/chat' ? 'text-primary' : 'text-muted-foreground hover:text-foreground'}`}>Chat</Link>
             <Link to="/knowledge" className={`text-sm font-medium transition-colors ${location.pathname === '/knowledge' ? 'text-primary' : 'text-muted-foreground hover:text-foreground'}`}>Knowledge Base</Link>
             <Link to="/timetable" className={`text-sm font-medium transition-colors ${location.pathname === '/timetable' ? 'text-primary' : 'text-muted-foreground hover:text-foreground'}`}>Timetable</Link>
          </div>
          <div className="flex items-center gap-4">
             <Settings size={18} className="text-muted-foreground hover:text-foreground cursor-pointer" />
             <AuthAvatar />
          </div>
        </div>
      )}
...
const AuthButtons = () => {
  ...
  if (session) {
    return (
      <button onClick={() => logout().then(() => window.location.reload())} className="px-5 py-2 rounded-full border border-border/80 bg-background/50 text-sm font-medium text-foreground hover:bg-foreground/10 transition-colors">
        Log Out
      </button>
    );
  }
  ...
  return (
    <button onClick={() => loginWithGoogle()} className="px-5 py-2 rounded-full border border-border/80 bg-background/50 text-sm font-medium text-foreground hover:bg-foreground/10 transition-colors">
      Log In
    </button>
  );
};
